...
function insert() {
    ...
    var attr;
    var pic = 0;
    var isUsed = new Array(false, false, false, false, false, false, false, false);
    while (ctr < 16) {
        if (ctr % 2 == 0 && ctr == 0) {
